...
public class MiFila {
    ...
    /**
     * Metodo que nos permite convertir la fila en un arreglo
    ...
    /**
     * Metodo que nos permite sacar el valor del inicio de la cola.
     * @return el valor que sacamos (el primero que agregamos).
     * En blanco si no hay.
     */
    public String poll(){
        String value = "";
